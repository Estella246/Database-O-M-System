...
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (50, 4, 'is_consult_issue', '是否咨询问题', 'whitelist', true, false, 'none', NULL, 26, '{"optional_when_all": [{"field": "handle_mode", "values": ["提交其他开发分析", "返回运维分析"]}]}', '{"inherit_previous": false}', 10, true, '2026-04-09 11:32:19.257884+08', '2026-04-09 12:16:20.928615+08');
