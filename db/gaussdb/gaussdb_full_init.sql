...
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (2, 1, 'location', '局点', 'text', true, false, 'none', NULL, NULL, NULL, NULL, 2, true, '2026-04-09 00:45:07.921292+08', '2026-04-09 00:45:07.921292+08');
...
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (6, 1, 'product_line', '产品线', 'whitelist', true, false, 'none', NULL, 13, NULL, '{"inherit_previous": false}', 6, true, '2026-04-09 00:45:07.921292+08', '2026-04-09 00:45:07.921292+08');
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (8, 1, 'ecare_ticket_no', 'eCare单号', 'text', true, false, 'none', NULL, NULL, NULL, NULL, 7, true, '2026-04-09 00:45:07.921292+08', '2026-04-09 00:45:07.921292+08');
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (9, 1, 'hcs_owner', '提单人', 'text', true, true, 'login_user', 'employee_id+name', NULL, NULL, NULL, 8, true, '2026-04-09 00:45:07.921292+08', '2026-04-09 00:45:07.921292+08');
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (10, 1, 'issue_desc', '问题描述', 'richtext', true, false, 'none', NULL, NULL, NULL, NULL, 9, true, '2026-04-09 00:45:07.921292+08', '2026-04-09 00:45:07.921292+08');
...
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (28, 3, 'gauss_version', '内核版本', 'whitelist', true, false, 'none', NULL, 17, '{"optional_when_all": [{"field": "handle_mode", "values": ["提交其他运维分析"]}]}', '{"inherit_previous": false}', 15, true, '2026-04-09 11:32:19.257884+08', '2026-04-09 12:07:27.674078+08');
...
INSERT INTO public.node_field_def (id, node_id, field_key, field_name, field_type, required, read_only, default_type, default_value, option_set_id, constraints_json, ui_props_json, sort_order, is_active, created_at, updated_at) VALUES (33, 3, 'control_version', '管控版本', 'text', false, false, 'none', NULL, NULL, '{"required_if": {"component": "管控问题"}, "optional_when_all": [{"field": "handle_mode", "values": ["提交其他运维分析"]}]}', '{"inherit_previous": false}', 20, true, '2026-04-09 11:32:19.257884+08', '2026-04-09 12:07:27.674078+08');
