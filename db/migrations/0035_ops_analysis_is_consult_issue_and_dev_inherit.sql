...
os AS (
  SELECT id AS option_set_id FROM option_set WHERE set_code = 'OS_DEV_ANALYSIS_CONSULT' LIMIT 1
)
...
WHERE nfd.node_id = wn.id
  ...
  AND nfd.field_key = 'is_consult_issue';
